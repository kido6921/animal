...
let GameState = {
    ...
    preload: function(){ //Load images and sound
        //Images
        this.load.image('background','https://s3.us-east-2.amazonaws.com/www.kassetstore.com/assets/phaser/farm-animal/images/background.png')
        this.load.image('arrow','https://s3.us-east-2.amazonaws.com/www.kassetstore.com/assets/phaser/farm-animal/images/arrow.png')
        this.load.image('bull' ,'https://s3.us-east-2.amazonaws.com/www.kassetstore.com/assets/phaser/farm-animal/images/bull.png')
        this.load.image('cat','https://s3.us-east-2.amazonaws.com/www.kassetstore.com/assets/phaser/farm-animal/images/cat.png')            
        this.load.image('chicken', 'https://s3.us-east-2.amazonaws.com/www.kassetstore.com/assets/phaser/farm-animal/images/chicken.png')
        this.load.image('cow','https://s3.us-east-2.amazonaws.com/www.kassetstore.com/assets/phaser/farm-animal/images/cow.png')
        this.load.image('dog','https://s3.us-east-2.amazonaws.com/www.kassetstore.com/assets/phaser/farm-animal/images/dog.png')
        this.load.image('duck','https://s3.us-east-2.amazonaws.com/www.kassetstore.com/assets/phaser/farm-animal/images/duck.png')
        this.load.image('goat','https://s3.us-east-2.amazonaws.com/www.kassetstore.com/assets/phaser/farm-animal/images/goat.png')
        this.load.image('horse','https://s3.us-east-2.amazonaws.com/www.kassetstore.com/assets/phaser/farm-animal/images/horse.png')
        this.load.image('mouse','https://s3.us-east-2.amazonaws.com/www.kassetstore.com/assets/phaser/farm-animal/images/mouse.png')
        this.load.image('pig','https://s3.us-east-2.amazonaws.com/www.kassetstore.com/assets/phaser/farm-animal/images/pig.png')
        this.load.image('rabbit','https://s3.us-east-2.amazonaws.com/www.kassetstore.com/assets/phaser/farm-animal/images/rabbit.png')
        this.load.image('sheep','https://s3.us-east-2.amazonaws.com/www.kassetstore.com/assets/phaser/farm-animal/images/sheep.png')
        this.load.image('turkey','https://s3.us-east-2.amazonaws.com/www.kassetstore.com/assets/phaser/farm-animal/images/turkey.png')
        //Sounds
